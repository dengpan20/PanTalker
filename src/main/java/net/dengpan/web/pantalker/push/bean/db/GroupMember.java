...
public class GroupMember {
    ...
    public net.dengpan.web.pantalker.push.bean.db.User getUser() {
        return user;
    }

    public void setUser(net.dengpan.web.pantalker.push.bean.db.User user) {
        this.user = user;
    }
    ...
    public net.dengpan.web.pantalker.push.bean.db.Group getGroup() {
        return group;
    }

    public void setGroup(net.dengpan.web.pantalker.push.bean.db.Group group) {
        this.group = group;
    }
